  ...
  return (
    <div className="min-h-screen bg-[#f5f3f0] flex items-center justify-center p-4 md:p-8">
      <div ref={cardRef} className="relative w-full max-w-md" style={{ minHeight: '800px' }}>
          ...
          <div data-rsvp-section className="absolute bottom-8 left-4 right-4 z-30">
            <div className="bg-white/90 backdrop-blur-sm rounded-lg p-4 border border-[#c9a84c]/30 text-center">
              ...
              <button
                ...
                disabled={pdfLoading}
                className="mt-3 flex items-center justify-center gap-2 w-full bg-[#2a2a2a] hover:bg-[#1a1a1a] text-white py-2 rounded-lg text-[10px] tracking-wider uppercase font-medium transition-all shadow disabled:opacity-60"
              >
                {pdfLoading ? (
                  <>
        ...
        <div data-footer-section className="absolute bottom-2 left-0 right-0 text-center z-30">
          <p className="text-[#9a8a6a] text-[9px] tracking-wider">
            {info.brideName || 'Couple'} & {info.groomName || 'Couple'} • 2026
          </p>
        </div>
      </div>
    </div>
